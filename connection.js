...
client.connect((err)=> {
    ...
    let createUsersTable = `CREATE TABLE IF NOT EXISTS USERS(ni int PRIMARY KEY,
    ...
    client.query(createDiscussionTable, (err, result, fields) => {
        ...
        let query = 'SELECT * FROM DISCUSSION;';
            client.query(query, (err, result) => {
                ...
                if (users.rowCount === 0) {
                    let createDiscussion = `INSERT INTO DISCUSSION(nim, name, email, title, category, priority, question, answer)
                    VALUES ('181050107', 'fadhil', 'fadhil@email,com', 'kabar', 'mahasiswa', 'rendah', 'apa kabar?', null);`;
